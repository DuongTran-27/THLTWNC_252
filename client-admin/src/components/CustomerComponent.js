...
class Customer extends Component {
    ...
    apiPutCustomerDeactive(_id, token) {
        const body = {
            token: token
        };
        const config = {
        ...
        axios
            .put('/api/admin/customer/deactive/' + _id, body, config)
            .then((res) => {
                const result = res.data;
                if (result) {
                    this.apiGetCustomers();
    ...
    lnkEmailClick(item) {
        this.apiPostCustomerSendmail(item._id);
    }
    apiPostCustomerSendmail(_id) {
        const config = {
            headers: { 'x-access-token': this.context.token }
        };
        axios
            .get('/api/admin/customer/sendmail/' + _id, config)
            .then((res) => {
                const result = res.data;
